        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex items-center justify-around">
            ...
            <div className="px-32 py-10  relative">
              ...
              <div className="absolute top-40 left-5 bg-pwhite rounded-2xl px-10 py-10 w-64 z-10 shadow-lg hover:shadow-2xl hover:scale-105 cursor-pointer transition duration-500 ease-in-out">
                <svg
                  width="103"
                  height="103"
                  viewBox="0 0 103 103"
